...
import (
	...
	db "github.com/RahilRehan/banco/db"
...
// TransferTx provides a mock function with given fields: ctx, args
func (_m *Store) TransferTx(ctx context.Context, args db.TransferTxParams) (db.TransferTxResult, error) {
